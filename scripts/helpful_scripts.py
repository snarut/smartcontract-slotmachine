...
DECIMALS = 18
INITIAL_VALUE = Web3.toWei(1, "ether")
...
def deploy_mocks(decimals=DECIMALS, initial_value=INITIAL_VALUE):
    ...
    dai_token.mint(account, Web3.toWei(100, "ether"))
    print(f"Deployed to {dai_token.address}. Balance in account is {dai_token.balanceOf(account)}")
